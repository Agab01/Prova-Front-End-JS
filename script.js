...
function showSlides(n) {
    ...
    }, 2500); // 4000 milissegundos = 4 segundos
}
...
const menuLinks = document.getElementById('myTopnav');

// Adiciona um evento de clique no ícone de hambúrguer
menuIcon.addEventListener('click', function (event) {
  event.preventDefault(); // Previne o comportamento padrão de navegação do link
